...
namespace project_manage_system_backend.Controllers
{
    ...
    public class ProjectController : ControllerBase
    {
        ...
        [Authorize]
        [HttpPost("editcover")]
        public IActionResult EditProjectCover(ProjectResultDto projectResultDto)
        {
            try
            {
                CheckUserIsProjectOwner(User.Identity.Name, projectResultDto.Id);
                _projectService.EditProjectCoverImage(projectResultDto);
                return Ok(new ResponseDto
                {
                    success = true,
                    message = "Eddited Success",
                });
            }
            catch (Exception ex)
            {
